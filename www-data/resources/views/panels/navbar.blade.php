...
{{--          </li>--}}
         ...
         @if(session()->has('dark'))
                <li class="nav-item me-2 me-xl-0 d-flex align-items-center">
                    <a class="nav-link style-switcher-toggle hide-arrow" href="{{route('toggleDark')}}" data-bs-original-title="" title="">
...
{{--              <div class="dropdown-divider mb-0"></div>--}}
                <form action="{{route('logout')}}" method="post">
                    @csrf
                    <button class="dropdown-item"><i class="bx bx-power-off mr-50"></i> Logout</button>
