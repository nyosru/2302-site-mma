...
class GeneralController extends BaseController
{
    ...
    public function event($id, $eventName = 'something', Request $request)
    {
        ...
        if (isset($_GET['payout'])) {
            if ($_GET['payout'] <= 0) { //  - regist
                ...
                return response()->json(array_merge($af_result, $answer));
            }
        }
    ...
    public function sendToAppsflyer($app_id, $af_dev_key, $data)
    {
